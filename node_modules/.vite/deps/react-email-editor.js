...
var require_react_email_editor_cjs_development = __commonJS({
  "node_modules/react-email-editor/dist/react-email-editor.cjs.development.js"(exports) {
    "use strict";
    ...
    var callbacks = [];
    var loaded = false;
    var isScriptInjected = function isScriptInjected2(scriptUrl) {
      var scripts2 = document.querySelectorAll("script");
      var injected = false;
      scripts2.forEach(function(script) {
    ...
    var addCallback = function addCallback2(callback) {
      callbacks.push(callback);
    };
    var runCallbacks = function runCallbacks2() {
      if (loaded) {
        var callback;
    ...
    var loadScript = function loadScript2(callback, scriptUrl) {
      if (scriptUrl === void 0) {
    ...
    var EmailEditor = React__default.forwardRef(function(props, ref) {
...
var require_dist = __commonJS({
  "node_modules/react-email-editor/dist/index.js"(exports, module) {
    if (false) {
      module.exports = null;
    } else {
      module.exports = require_react_email_editor_cjs_development();
    }
  }
});
export default require_dist();
//# sourceMappingURL=react-email-editor.js.map
