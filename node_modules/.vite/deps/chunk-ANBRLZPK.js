...
var DropdownItem = React.memo(function(props) {
  ...
  return React.createElement("li", _extends({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React.createElement("span", itemGroupLabelProps, content), React.createElement(Ripple, null));
});
...
var Dropdown = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React.useState(-1), _React$useState4 = _slicedToArray(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
  ...
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = !overlayVisibleState ? props.dropdownIcon || React.createElement(ChevronDownIcon, dropdownIconProps) : props.collapseIcon || React.createElement(ChevronUpIcon, dropdownIconProps);
...
//# sourceMappingURL=chunk-ANBRLZPK.js.map
